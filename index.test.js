...
test('test create message with attachments with multiple lines', () => {
      ...
      "fields": [
        {
          ...
          "value": "Merge pull request #2 from tokorom/test
  
  複数行のcommit messages　"
        },
        {
          "title": "GitHub Actions URL",
          "value": "https://github.com/tokorom/github-actions-sandbox/actions/runs/103198369"
        },
        {
          "title": "Compare URL",
          "value": "https://github.com/tokorom/github-actions-sandbox/compare/97aab62ea3dd...feed685e572a"
        }
      ]
    }
  ]`
  ...
  const message = createMessage()
  expect(message.attachments[0].fields[1].value).toEqual('https://github.com/tokorom/github-actions-sandbox/actions/runs/103198369')
})
